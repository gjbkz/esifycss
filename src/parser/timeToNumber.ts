...
export const timeValueToNumber = (
    timeValueNode: INBNFASTNode,
): number => parseFloat(nodeToString(timeValueNode));

export const timeUnitToNumber = (
    timeUnitNode: INBNFASTNode,
): number => {
